...
var docPeople = document.getElementById("docPeople");
var editingRow = null;
function saveToStorage() {
    ...
    Array.from(rows).forEach(function (row) {
        ...
        var obj = { name: name, status: status, people: people, date: date };
        data.push(obj);
    });
...
function loadFromStorage() {
    ...
    docs.forEach(function (doc) {
        ...
        td3.innerHTML = "<span class=\"status ".concat(statusClass, "\">").concat(doc.status, "</span>");
        if (doc.status === "Pending") {
            td3.innerHTML +=
                "<br><small><span class=\"pname\">Waiting for </span><span class=\"sname\">".concat(doc.people, " people</span></small>");
        }
        row.appendChild(td3);
...
saveBtn.onclick = function () {
    ...
    if (editingRow !== null) {
        ...
        cells[2].innerHTML = "<span class=\"status ".concat(statusClass, "\">").concat(status, "</span>");
        if (status === "Pending") {
            cells[2].innerHTML +=
                "<br><small><span class=\"pname\">Waiting for </span><span class=\"sname\">".concat(people, " people</span></small>");
        }
        ...
        row.appendChild(td2);
        var td3 = document.createElement("td");
        td3.innerHTML = "<span class=\"status ".concat(statusClass, "\">").concat(status, "</span>");
        if (status === "Pending") {
            td3.innerHTML +=
                "<br><small><span class=\"pname\">Waiting for </span><span class=\"sname\">".concat(people, " people</span></small>");
        }
...
document.onclick = function (e) {
    ...
    if (target.className.includes("menu-btn")) {
        var menu = (_a = target.parentElement) === null || _a === void 0 ? void 0 : _a.getElementsByClassName("menu-dropdown")[0];
